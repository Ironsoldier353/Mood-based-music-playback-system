  ...
  const floatingIcons = [
    {
      icon: Music,
      className:
        "top-[10%] left-[5%] sm:top-[15%] sm:left-[8%] text-purple-400/50",
      delay: "delay-300",
    ...
    },
    {
      icon: Headphones,
      className:
        "top-[20%] right-[8%] sm:top-[25%] sm:right-[12%] text-pink-400/50",
      delay: "delay-700",
      size: "w-6 h-6 sm:w-8 sm:h-8",
    },
    {
      icon: Waves,
      className:
        "bottom-[25%] left-[10%] sm:bottom-[30%] sm:left-[15%] text-blue-400/50",
      delay: "delay-500",
      size: "w-6 h-6 sm:w-8 sm:h-8",
    },
    {
      icon: Heart,
      className:
        "bottom-[15%] right-[12%] sm:bottom-[20%] sm:right-[16%] text-red-400/50",
      delay: "delay-1000",
      size: "w-6 h-6 sm:w-8 sm:h-8",
    },
    {
      icon: Mic2,
      className:
        "top-[35%] right-[20%] sm:top-[40%] sm:right-[25%] text-purple-300/40",
      delay: "delay-1200",
    ...
    },
    {
      icon: Disc3,
      className:
        "bottom-[45%] left-[15%] sm:bottom-[50%] sm:left-[20%] text-blue-300/40",
      delay: "delay-800",
      size: "w-5 h-5 sm:w-6 sm:h-6",
    },
    {
      icon: Radio,
      className:
        "top-[60%] right-[25%] sm:top-[65%] sm:right-[30%] text-pink-300/40",
      delay: "delay-600",
      size: "w-5 h-5 sm:w-6 sm:h-6",
    },
    {
      icon: Volume2,
      className: "top-[45%] left-[8%] text-green-300/40",
      delay: "delay-400",
      size: "w-4 h-4 sm:w-5 sm:h-5",
    },
    {
      icon: Star,
      className: "bottom-[60%] right-[8%] text-yellow-300/40",
      delay: "delay-900",
      size: "w-4 h-4 sm:w-5 sm:h-5",
    },
    {
      icon: Zap,
      className: "top-[75%] left-[25%] text-orange-300/40",
      delay: "delay-1100",
      size: "w-4 h-4 sm:w-5 sm:h-5",
    },
    {
      icon: Shuffle,
      className: "bottom-[35%] right-[35%] text-indigo-300/40",
      delay: "delay-1300",
      size: "w-4 h-4 sm:w-5 sm:h-5",
    },
  ];
  ...
  return (
    ...
    >
      ...
      {floatingIcons.map(({ icon: Icon, className, delay, size }, index) => (
        <div
          key={index}
          className={`absolute ${className} animate-float ${delay} z-10 hidden sm:block`}
        >
          <Icon className={size} />
        </div>
      ))}
      ...
      <div
        className={`relative z-10 flex flex-col items-center justify-center min-h-screen px-4 sm:px-6 lg:px-8 transition-all duration-1000 ${
      ...
      >
        <div className="text-center max-w-7xl mx-auto w-full">
          ...
          <div className="mb-8 sm:mb-12 lg:mb-16 pt-8 sm:pt-12">
            ...
            <div className="relative space-y-3 sm:space-y-4 lg:space-y-6">
              <p className="text-base sm:text-lg md:text-xl lg:text-2xl xl:text-3xl text-purple-200 font-light tracking-wider">
                Experience{" "}
                <span className="font-medium bg-gradient-to-r from-pink-400 to-purple-400 text-transparent bg-clip-text animate-pulse">
                  mood-based
                </span>{" "}
                music playback
              </p>
              <p className="text-sm sm:text-base lg:text-lg xl:text-xl text-purple-300/90 max-w-xs sm:max-w-md lg:max-w-2xl xl:max-w-3xl mx-auto leading-relaxed tracking-wide px-2 sm:px-0">
                Let your emotions guide your playlist. Discover music that
                perfectly matches your current vibe and transforms your
                listening experience into something extraordinary.
              </p>
            </div>
          </div>
          ...
          <div className="flex flex-col sm:flex-row justify-center gap-3 sm:gap-4 lg:gap-6 mb-12 sm:mb-16 lg:mb-20 px-4 sm:px-0">
            ...
            <Link
              href="/sign-in"
              className="group relative px-6 sm:px-8 lg:px-10 py-3 sm:py-4 lg:py-5 bg-white/10 backdrop-blur-sm text-white font-semibold rounded-xl sm:rounded-2xl border border-white/20 hover:bg-white/20 hover:border-white/30 transition-all duration-300 transform hover:scale-105 active:scale-95 overflow-hidden"
            >
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6 lg:gap-8 max-w-6xl mx-auto px-2 sm:px-0">
            {[
              ...
              >
                <div
                  className={`w-10 h-10 sm:w-12 sm:h-12 lg:w-14 lg:h-14 bg-gradient-to-r ${feature.gradient} rounded-lg sm:rounded-xl flex items-center justify-center mb-3 sm:mb-4 lg:mb-6 mx-auto shadow-lg backdrop-blur-sm`}
                >
                  {feature.icon}
                </div>
                <h3 className="text-white font-semibold mb-2 sm:mb-3 tracking-wide text-sm sm:text-base lg:text-lg">
                  {feature.title}
                </h3>
                <p className="text-purple-200 text-xs sm:text-sm lg:text-base tracking-wide leading-relaxed">
                  {feature.desc}
                </p>
              </div>
            ))}
          ...
          <div className="mt-12 sm:mt-16 lg:mt-20 mb-8 sm:mb-12">
            <p className="text-purple-200/90 mb-4 sm:mb-6 lg:mb-8 tracking-wider text-sm sm:text-base lg:text-lg">
            ...
            >
              ...
              <div className="relative flex items-center justify-center gap-2 sm:gap-3 lg:gap-4">
                <span className="text-sm sm:text-base lg:text-lg xl:text-xl tracking-wider">
      ...
      <button
        onClick={scrollToTop}
        className={`fixed bottom-6 right-6 sm:bottom-8 sm:right-8 z-50 w-12 h-12 sm:w-14 sm:h-14 bg-gradient-to-br from-purple-600 to-pink-600 rounded-full flex items-center justify-center shadow-xl transition-all duration-300 transform ${
          showScrollButton
